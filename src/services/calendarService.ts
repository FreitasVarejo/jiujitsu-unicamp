 ...
 */
const fetchEvents = async (timeMin: string, timeMax: string): Promise<GoogleCalendarEvent[]> => {
...
export const calendarService = {
   ...
   */
  getEventsByRange: async (start: string, end: string): Promise<GoogleCalendarEvent[]> => {
