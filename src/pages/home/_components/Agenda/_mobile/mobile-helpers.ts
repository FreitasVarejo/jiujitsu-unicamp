...
export const performScroll = (
  ...
  console.log("[AgendaMobile] Date parsing:", {
    today,
    year,
    month,
    day,
  ...
  if (dayOfWeek === 0) {
    ...
    console.log("[AgendaMobile] Saturday detected → scroll to max", {
      targetScroll,
    });
  } else {
    ...
    console.log(
      "[AgendaMobile] Weekday (Mon-Fri) detected → scroll to 35% position",
      { targetScroll }
    );
  }

  // Executa scroll suave
  console.log("[AgendaMobile] Executing scroll:", {
    targetScroll,
    behavior: "smooth",
  });
